...
- 📖 [마크다운 사용자 가이드 (Markdown)](docs/guide.md) · [실무 매뉴얼](docs/cru-manual.md) · [시스템 아키텍처](docs/ARCHITECTURE.md) · [REST & MCP](docs/API.md) · [오프라인 배포](docs/OFFLINE.md) · [관리자 가이드](docs/ADMIN_GUIDE.md)
